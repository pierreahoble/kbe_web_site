                ...
                <div class="row align-items-end">
                    <div class="col-xl-8 col-lg-7 order-2 order-lg-1">
                        <div class="pg-features__description">
                            <span class="pg-features__icon">
                                <img src="{{ asset('client/images/icons/service-icon-digital.png')}}"
                            ...
                            <div class="pg-features__content">
                                ...
                                <p>
                                    ...
                                    autres domaines d’intervention du cabinet.
                                </p>
                                <p>
                                    En s’appuyant sur des langages informatiques puissants tels que JAVA, PYTHON, PHP ou
                                    encore des technologies de pointes révolutionnaires telles que l’intelligence
                                    artificielle et la data science, MERCANTO modélise et propose des solutions de
                                    gestion comptables, financières et fiscales qui allient haute technicité et
                    ...
                    <div class="col-xl-4 col-lg-5 wow fadeInRight order-1 order-lg-2">
                        <div class="pg-features__thumb">
                            <img src="client/images/feature/feature-thumb-6.jpg" alt="feature thumb 1">
                        </div>
                    </div>
                </div>
            </div>
